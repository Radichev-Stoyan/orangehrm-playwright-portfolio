...
('csrf_secret','Qj3rOfLMtF3p_tiTX6FhkFAj0-3WPZEOQOkbu4pXEpD8B6Z_SJymcIJjnmrQsFnUVEk83x26k-H6bQDAHNGDLg'),
...
('instance.identifier','T3JhbmdlSFJNIFRlc3RfYmJveWhhc3NlbGhvZmZAZ21haWwuY29tX1N0b3lhbl9SYWRpY2hldl9sb2NhbGhvc3Q6ODA4MF9CR181LjlfMTc4MzMzODAwMA=='),
('instance.reg_consent','1'),
('instance.version','5.9.0'),
...
('oauth.encryption_key','HjfLIxRJ8GvehDN3m3UD1B6GkuQmxDHtc7wMjiJhBLM='),
('oauth.refresh_token_ttl','P1M'),
('oauth.token_encryption_key','Kg8978m3yYcCWGomSuy4F3YLBI8T3wvlp1BR9GoebgI='),
...
('workspace.notifications.enabled','0');
...
(1,'0001','Radichev','Stoyan','','',0,NULL,NULL,NULL,NULL,NULL,'','','','',NULL,'',NULL,NULL,NULL,NULL,'','','','','',NULL,NULL,NULL,NULL,'bboyhasselhoff@gmail.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(2,'49168','Tester3062','QA1783338149168','Auto','',0,NULL,'1992-06-15',NULL,NULL,'','','','','',NULL,'',NULL,NULL,NULL,NULL,'','','','','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(3,'83498','Tester1328','QA1783338183498','Auto','',0,NULL,'1992-06-15',NULL,NULL,'','','','','',NULL,'',NULL,NULL,NULL,NULL,'','','','','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
(197,2,278,'OrangeHRM\\WorkspaceNotifications\\Api\\WorkspaceNotificationConfigAPI'),
(198,2,279,'OrangeHRM\\WorkspaceNotifications\\Api\\WorkspaceNotificationRegistrationAPI'),
(199,2,280,'OrangeHRM\\WorkspaceNotifications\\Api\\WorkspaceNotificationTestWebhookAPI');
...
(278,'apiv2_admin_workspace_notification_config','API-v2 Admin - Workspace Notification Configuration',1,0,1,0),
(279,'apiv2_admin_workspace_notification_registrations','API-v2 Admin - Workspace Notification Registrations',1,1,1,1),
(280,'apiv2_admin_workspace_notification_test','API-v2 Admin - Workspace Notification Test Webhook',0,1,0,0);
...
(1,2,'employee','SAVE','Saving Employee','2026-07-06 11:42:30','Admin'),
(2,2,'employee','UPDATE','Updating Employee Details','2026-07-06 11:42:35','Admin'),
(3,3,'employee','SAVE','Saving Employee','2026-07-06 11:43:05','Admin'),
(4,3,'employee','UPDATE','Updating Employee Details','2026-07-06 11:43:09','Admin');
...
(1244,'reset_password_link_was_not_sent',19,'Reset password link was not sent',NULL,'5.8.0'),
(1245,'your_reset_password_link_not_sent_error',19,'Your reset password link was not sent due to an error.',NULL,'5.8.0'),
(1246,'please_contact_admin_reset_password',19,'Please contact your administrator to reset your password.',NULL,'5.8.0'),
(1247,'session_expired',19,'Session Expired',NULL,'5.8.0'),
(1248,'work_email_invalid_characters',3,'Work email contains invalid characters.',NULL,'5.8.0'),
(1249,'workspace_notification_configuration',2,'Workspace Notification Configuration',NULL,NULL),
(1250,'notification_registration',2,'Notification Registration',NULL,NULL),
(1251,'edit_notification_registration',2,'Edit Notification Registration',NULL,NULL),
(1252,'notification_registrations',2,'Notification Registrations',NULL,NULL),
(1253,'workspace_notification_form_hint',2,'Configure a workspace channel (Slack, Google Chat, or Teams) to receive automated notifications. Each registration has its own timezone and send time.',NULL,NULL),
(1254,'platform',2,'Platform',NULL,NULL),
(1255,'platform_slack',2,'Slack',NULL,NULL),
(1256,'platform_google_chat',2,'Google Chat',NULL,NULL),
(1257,'slack_incoming_webhook_url',2,'Slack Incoming Webhook URL',NULL,NULL),
(1258,'google_chat_webhook_url',2,'Google Chat Webhook URL',NULL,NULL),
(1259,'teams_workflow_url',2,'Microsoft Teams Workflow URL',NULL,NULL),
(1260,'slack_webhook_hint',2,'Create an Incoming Webhook in your Slack workspace and paste the URL here. Must be HTTPS.',NULL,NULL),
(1261,'google_chat_webhook_hint',2,'Create an Incoming Webhook in your Google Chat workspace and paste the URL here. Must be HTTPS.',NULL,NULL),
(1262,'workspace_notification_channel_name_optional',2,'Channel Name (Optional)',NULL,NULL),
(1263,'workspace_notification_channel_hint',2,'Label only (e.g. #hr-team). The webhook URL determines the actual destination.',NULL,NULL),
(1264,'sub_units',2,'Sub Units',NULL,NULL),
(1265,'workspace_notification_subunit_hint',2,'Filter by subunit(s): leave empty to include all employees, or pick one or more subunits to limit notifications.',NULL,NULL),
(1266,'workspace_notification_timezone_hint',2,'Select the time zone to send this notification.',NULL,NULL),
(1267,'channel',2,'Channel',NULL,NULL),
(1268,'send_time',2,'Send Time',NULL,NULL),
(1269,'workspace_notification_send_time_hint',2,'Local send time (HH:mm).',NULL,NULL),
(1270,'all_employees',2,'All Employees',NULL,NULL),
(1271,'send_test',2,'Send Test',NULL,NULL),
(1272,'slack_webhook_url_invalid',2,'Should be a valid Slack Incoming Webhook URL (https://hooks.slack.com/services/…)',NULL,NULL),
(1273,'google_chat_webhook_url_invalid',2,'Should be a valid Google Chat webhook URL (https://chat.googleapis.com/v1/spaces/…?key=…&token=…)',NULL,NULL),
(1274,'add_registration',2,'+ Add Registration',NULL,NULL),
(1275,'update',2,'Update',NULL,NULL),
(1276,'workspace_notification_event_birthday',2,'Birthday',NULL,NULL),
(1277,'workspace_notification_no_registrations_hint',2,'No registrations yet. Fill the form above and click + Add Registration to create one.',NULL,NULL),
(1278,'workspace_notification_cron_reminder',2,'Ensure the server cron runs php bin/console orangehrm:run-schedule regularly (e.g. every 5–15 minutes) so scheduled notifications can run.',NULL,NULL),
(1279,'workspace_notification_platform_changed_hint',2,'Chat Platform changed. Paste a new {platform} Webhook URL for this channel before saving.',NULL,NULL),
(1280,'workspace_notification_duplicate_dialog_title',2,'Possible duplicate registration',NULL,NULL),
(1281,'workspace_notification_duplicate_dialog_subtitle',2,'Another registration already targets the same event type, workspace channel, and subunit. Saving this will cause the same message to be sent more than once per day. Do you want to save anyway?',NULL,NULL),
(1282,'workspace_notification_go_back_and_fix',2,'Go back and edit',NULL,NULL),
(1283,'workspace_notification_schedule_info',2,'Scheduling an event here triggers the configured notification flows automatically. Ensure the server cron runs php bin/console orangehrm:run-schedule regularly (e.g. every 5–15 minutes) so scheduled notifications can run.',NULL,NULL),
(1284,'workspace_notification_send_test_dialog_title',2,'Send a test message?',NULL,NULL),
(1285,'workspace_notification_send_test_dialog_subtitle',2,'This will deliver a sample notification to the channel for this registration. It works regardless of whether the row is active.',NULL,NULL),
(1286,'workspace_notification_duplicate_warning',2,'Heads up: a similar registration already exists. The same message may be sent more than once per day.',NULL,NULL),
(1287,'workspace_notification_save_failed',2,'Failed to save. Check the webhook URL and try again.',NULL,NULL),
(1288,'workspace_notification_test_sent',2,'Test message sent to the configured channel.',NULL,NULL),
(1289,'workspace_notification_test_failed',2,'Failed to send test message. Check the webhook URL.',NULL,NULL),
(1290,'workspace_notification_status_update_failed',2,'Could not update status. Refresh and try again.',NULL,NULL),
(1291,'workspace_notification_global_toggle_failed',2,'Could not update global toggle.',NULL,NULL),
(1292,'teams_webhook_hint',2,'Create a Power Automate \"Post to channel\" workflow with an HTTP trigger and paste the workflow URL here. Must be HTTPS.',NULL,NULL),
(1293,'teams_webhook_url_invalid',2,'Should be a valid Microsoft Teams Power Automate workflow URL',NULL,NULL),
(1294,'google_chat_webhook_key_token_required',2,'Google Chat webhook URL must include both key and token query parameters.',NULL,NULL),
(1295,'teams_webhook_sig_required',2,'Microsoft Teams workflow URL must include the sig query parameter.',NULL,NULL),
(1296,'workspace_notification_invalid_url',2,'Invalid URL.',NULL,NULL),
(1297,'workspace_notification_webhook_saved_hint',2,'(saved — leave blank to keep)',NULL,NULL);
...
(1,1,'Admin','Admin',1,'2026-07-06 11:42:28'),
(2,1,'Admin','Admin',1,'2026-07-06 11:43:03');
...
(113,'Workspace Notification Configuration',183,23,3,1100,1,NULL);
...
(1,'3.3.3','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:01','2026-07-06 11:40:20'),
(2,'4.0','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:20','2026-07-06 11:40:20'),
(3,'4.1','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:20','2026-07-06 11:40:20'),
(4,'4.1.1','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:20','2026-07-06 11:40:21'),
(5,'4.1.2','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:21','2026-07-06 11:40:21'),
(6,'4.1.2.1','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:21','2026-07-06 11:40:21'),
(7,'4.2','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:21','2026-07-06 11:40:21'),
(8,'4.2.0.1','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:21','2026-07-06 11:40:21'),
(9,'4.3','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:21','2026-07-06 11:40:21'),
(10,'4.3.1','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:21','2026-07-06 11:40:21'),
(11,'4.3.2','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:21','2026-07-06 11:40:21'),
(12,'4.3.3','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:21','2026-07-06 11:40:25'),
(13,'4.3.4','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:25','2026-07-06 11:40:25'),
(14,'4.3.5','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:25','2026-07-06 11:40:25'),
(15,'4.4','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:25','2026-07-06 11:40:26'),
(16,'4.5','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:26','2026-07-06 11:40:26'),
(17,'4.6','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:26','2026-07-06 11:40:28'),
(18,'4.6.0.1','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:28','2026-07-06 11:40:28'),
(19,'4.7','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:28','2026-07-06 11:40:28'),
(20,'4.8','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:28','2026-07-06 11:40:28'),
(21,'4.9','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:28','2026-07-06 11:40:28'),
(22,'4.10','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:28','2026-07-06 11:40:28'),
(23,'4.10.1','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:28','2026-07-06 11:40:28'),
(24,'5.0-beta','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:28','2026-07-06 11:40:30'),
(25,'5.0','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:40:30','2026-07-06 11:41:00'),
(26,'5.1.0','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:41:00','2026-07-06 11:41:05'),
(27,'5.2.0','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:41:05','2026-07-06 11:41:08'),
(28,'5.3.0','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:41:08','2026-07-06 11:41:10'),
(29,'5.4.0','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:41:10','2026-07-06 11:41:10'),
(30,'5.5.0','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:41:10','2026-07-06 11:41:12'),
(31,'5.6.0','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:41:12','2026-07-06 11:41:12'),
(32,'5.6.1','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:41:12','2026-07-06 11:41:12'),
(33,'5.7.0','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:41:12','2026-07-06 11:41:13'),
(34,'5.8.0','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:41:13','2026-07-06 11:41:13'),
(35,'5.8.1','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:41:13','2026-07-06 11:41:13'),
(36,'5.9.0','10.11.18-MariaDB-ubu2204','8.3.31','2026-07-06 11:41:13','2026-07-06 11:41:14');
...
(1,'OrangeHRM Test',NULL,NULL,NULL,NULL,NULL,'BG',NULL,NULL,NULL,NULL,NULL,NULL);
...
(1,0,1,'2026-07-06 11:40:00','2026-07-06 11:40:00','{\"username\":\"Admin\",\"email\":\"bboyhasselhoff@gmail.com\",\"telephone\":null,\"admin_first_name\":\"Stoyan\",\"admin_last_name\":\"Radichev\",\"timezone\":\"Not Captured\",\"language\":\"en_US\",\"country\":\"BG\",\"organization_name\":\"OrangeHRM Test\",\"type\":\"0\",\"instance_identifier\":\"T3JhbmdlSFJNIFRlc3RfYmJveWhhc3NlbGhvZmZAZ21haWwuY29tX1N0b3lhbl9SYWRpY2hldl9sb2NhbGhvc3Q6ODA4MF9CR181LjlfMTc4MzMzODAwMA==\",\"system_details\":\"{\\\"os\\\":{\\\"os\\\":\\\"Linux\\\",\\\"release_name\\\":\\\"6.18.33.2-microsoft-standard-WSL2\\\",\\\"version_info\\\":\\\"#1 SMP PREEMPT_DYNAMIC Thu Jun 18 21:54:43 UTC 2026\\\"},\\\"php\\\":{\\\"version\\\":\\\"8.3.31\\\"},\\\"mysql\\\":{\\\"client_version\\\":\\\"mysqlnd 8.3.31\\\",\\\"server_version\\\":\\\"10.11.18-MariaDB-ubu2204\\\",\\\"conn_type\\\":\\\"db via TCP\\\\\\/IP\\\"},\\\"server\\\":\\\"Apache\\\\\\/2.4.67 (Debian)\\\",\\\"ohrm\\\":{\\\"version\\\":\\\"5.9\\\"}}\"}'),
(2,3,1,'2026-07-06 11:41:16','2026-07-06 11:41:16','{\"instance_identifier\":\"T3JhbmdlSFJNIFRlc3RfYmJveWhhc3NlbGhvZmZAZ21haWwuY29tX1N0b3lhbl9SYWRpY2hldl9sb2NhbGhvc3Q6ODA4MF9CR181LjlfMTc4MzMzODAwMA==\",\"type\":3,\"system_details\":\"{\\\"os\\\":{\\\"os\\\":\\\"Linux\\\",\\\"release_name\\\":\\\"6.18.33.2-microsoft-standard-WSL2\\\",\\\"version_info\\\":\\\"#1 SMP PREEMPT_DYNAMIC Thu Jun 18 21:54:43 UTC 2026\\\"},\\\"php\\\":{\\\"version\\\":\\\"8.3.31\\\"},\\\"mysql\\\":{\\\"client_version\\\":\\\"mysqlnd 8.3.31\\\",\\\"server_version\\\":\\\"10.11.18-MariaDB-ubu2204\\\",\\\"conn_type\\\":\\\"db via TCP\\\\\\/IP\\\"},\\\"server\\\":\\\"Apache\\\\\\/2.4.67 (Debian)\\\",\\\"ohrm\\\":{\\\"version\\\":\\\"5.9\\\"}}\"}');
...
(183,'Admin - Workspace Notification Configuration',2,'workspaceNotificationConfiguration',NULL);
...
(1,1,1,'Admin','$2y$12$hMukPv6HEq0RpiE62i/dPOM0IN32bF/y7jKPyZAiTaYhal0T0PsmS',0,1,'2026-07-06 11:41:14',NULL,NULL,NULL);
...
-- Dump completed on 2026-07-06 11:46:10
